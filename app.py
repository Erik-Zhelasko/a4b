...
def home():
    ...
    # Load department names for dropdown
        ...
        try:
            cur.execute("""
                INSERT INTO employee (
                    ssn, fname, minit, lname, bdate, address, sex,
            ...
            conn.rollback()
            flash("Error: SSN must be unique.")
